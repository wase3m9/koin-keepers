...
export const ProcessSteps = () => {
  ...
  return (
    <section className="py-12 sm:py-20 lg:py-28 bg-gradient-to-b from-white via-gray-50/50 to-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            {steps.map((item, index) => (
              ...
              >
                {/* Card */}
                <div className="relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-[0_4px_40px_rgba(0,0,0,0.06)] border border-gray-100/80 hover:shadow-[0_8px_50px_rgba(0,0,0,0.1)] hover:border-primary/20 transition-all duration-500">
                  {/* Step number badge */}
                  <div className="absolute -top-4 sm:-top-5 left-6 sm:left-8">
                    <div className="relative">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-secondary flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="flex justify-end mb-6 sm:mb-8 mt-2">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-secondary mb-2 sm:mb-3">{item.title}</h3>
        ...
        >
          <Link
            to="/contact"
            className="group inline-flex items-center gap-2 sm:gap-3 bg-secondary text-primary px-6 sm:px-10 py-3 sm:py-4 rounded-full font-semibold text-sm sm:text-base hover:bg-secondary/90 transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.2)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.3)] hover:-translate-y-0.5"
          >
