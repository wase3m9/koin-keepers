...
export const Features = () => {
  ...
  return (
    <section aria-labelledby="features-heading" className="py-12 sm:py-20 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 id="features-heading" className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80 px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, index) => (
            <motion.article
              ...
              className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100"
            >
              <motion.div 
                initial={{ rotate: -6 }}
                whileHover={{ rotate: 0 }}
                transition={{ duration: 0.3 }}
                className="w-12 h-12 sm:w-14 sm:h-14 mx-auto bg-gradient-to-br from-primary to-primary/80 rounded-2xl flex items-center justify-center mb-4 sm:mb-6" 
                aria-hidden="true"
              >
                <motion.div
                  initial={{ rotate: 6 }}
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <feature.icon className="h-6 w-6 sm:h-7 sm:w-7 text-black" />
                </motion.div>
              </motion.div>
